...
export const products: Product[] = [
  ...
  },
  {
    ...
    materials:
      'Papel Washi Mino Hecho a Mano, Estructura de Bambú Ahumado, Base de Nogal',
    origin: 'Gifu, Japón',
    inStock: true,
  ...
  },
  {
    ...
    materials:
      'Hierro Fundido Nanbu Tekki, Interior Esmaltado, Mango Encordado de Cáñamo',
  ...
  },
  {
    ...
    materials:
      'Roble Japonés Macizo Carbonizado a Fuego, Acabado al Aceite Natural de Tung',
    origin: 'Nagano, Japón',
    inStock: true,
  ...
  },
  {
    ...
    materials:
      'Mármol Travertino Romano Poroso Natural, Almohadillas de Lana Fieltrada',
