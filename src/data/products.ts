...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Linterna escultórica elaborada a mano con fibras de morera (Kozo) según las técnicas seculares de Gifu. Proyecta una luz difusa y orgánica que recrea el efecto poético de la luz solar filtrada entre las hojas de los árboles.',
  ...
  },
  {
    ...
    description: 'Tetera y cuencos forjados en hierro fundido según la venerada tradición Nanbu Tekki de Iwate. Posee un esmaltado interior no reactivo y una textura exterior rugosa inspirada en la piedra volcánica negra, ideal para preservar la temperatura de infusión.',
  ...
  },
  {
    ...
    description: 'Columna monolítica elaborada en bloque macizo de roble japonés tratada mediante la técnica ancestral Shou Sugi Ban (Yakisugi). Su superficie de carbón profundo refleja matices sedosos y protege la madera de forma imperecedera.',
  ...
  },
  {
    ...
    description: 'Atril para libros de arte y lectura contemplativa esculpido en piedra caliza travertina porosa sin sellar. Cada pieza exhibe cavidades minerales únicas y una tonalidad crema cálida procedente de las históricas canteras del Lacio.',
